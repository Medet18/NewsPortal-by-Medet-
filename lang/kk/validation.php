...
//    "password"=> "Қате құпиясөз.",
    ...
    */
    'custom' => [
        ...
        'email' => [
            'required' => 'Біз сіздің электрондық пошта мекен-жайыңызды білуіміз керек!',
            'max' => 'Сіздің мекен-жайыңыз: attribute тым ұзақ!. ол бұдан былай болмауы керек: max',
        ],
        'name' => [
            'required' => 'Біз сіздің атыңызды білуіміз керек, атыңызды жазыңыз!',
            'between' => ': attribute :min және :max таңбаларының арасында болуы керек!',
        ],
        'password' => [
            'required' => 'Сіз құпиясөзді жазуыңыз керек!',
            'min' => 'Сіздің: attribute тым қысқа!. ол кем болмауы керек: :min',
        ],
    ],
